...
=======
getwd()
>>>>>>> d2e2ff52f96e5a8d0f9c36957ab355dbdadf9076
zstar <- qnorm(0.975)
...
load("r_estNULL_12192017.RData")
<<<<<<< HEAD
load("r_estNULL_4_12192017.RData")
load("r_est6_12192017.RData")
load("r_est6_4_12192017.RData")
load("r_est5_12192017.RData")
load("r_est5_4_12192017.RData")
load("r_est4_12192017.RData")
load("r_est4_4_12192017.RData")
load("r_est3_12192017.RData")
load("r_est3_4_12192017.RData")
=======
#load("r_estNULL_4_12192017.RData")
load("r_est6_12192017.RData")
#load("r_est6_4_12192017.RData")
...
load("biasOR_paper_NULL_12192017.RData")
load("biasOR_paper_6_1_12192017.RData")
load("biasOR_paper_6_12192017.RData")
load("biasOR_paper_5_1_12192017.RData")
load("biasOR_paper_5_12192017.RData")
load("biasOR_paper_4_1_12192017.RData")
load("biasOR_paper_4_12192017.RData")
load("biasOR_paper_3_1_12192017.RData")
load("biasOR_paper_3_12192017.RData")
@
...
<<coverageTabINTER, echo = FALSE, results = 'asis'>>=
tbl <- data.frame(DirectOR = r1, TPM.1 = covP[,1], RE.1 = r1re,  TPM.4 = covP[,2], row.names = c("RR = 1", "RR = 0.6", "RR = 0.5", "RR = 0.4", "RR = 0.3"))
xtable(tbl, align = c("cc|cc|c"), caption = "The coverage averaged across the 10,000 intervention allocations and 9 time periods for th eproposed Odds Ratio method, the random effects Odds Ratio estimates, and the test-positive method using pooled variance estimation. The proposed Odds Ratio Method is invariant to r.", digits = 8)
>>>>>>> d2e2ff52f96e5a8d0f9c36957ab355dbdadf9076
@
