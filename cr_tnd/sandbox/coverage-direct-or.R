# The coverage for the Direct Odds Ratio Method

# Ratio = 1
set.seed(123242)
biasOR.paper.NULL.1 <- paperFunction2(dataRAND, 1, period1, ratio = 1, ncases = 1000)
save(biasOR.paper.NULL.1, file = "biasOR_paper_NULL_1_12192017.RData")
biasOR.paper.6.1 <- paperFunction2(dataRAND, 0.6, period1, ratio = 1, ncases = 1000)
save(biasOR.paper.6.1, file = "biasOR_paper_6_1_12192017.RData")
biasOR.paper.5.1 <- paperFunction2(dataRAND, 0.5, period1, ratio = 1, ncases = 1000)
save(biasOR.paper.5.1, file = "biasOR_paper_5_1_12192017.RData")
